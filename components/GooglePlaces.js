            ...
            <PlacesAutocomplete 
                ...
                onSelect={handleSelect}>
                    {({ getInputProps, suggestions, getSuggestionItemProps, loading })=>(
                        ...
                        />
                            <div className="autocomplete-dropdown-container absolute mt-2 top-100 left-0 w-full p-4 rounded-md shadow bg-white">
                            {loading && <div className="absolute mt-2 top-100 left-0 w-full p-4 rounded-md shadow bg-white">Loading...</div>}
                            {suggestions.map(suggestion => {
                              ...
                              return (
                                ...
                                >
                                  <span className="p-2 rounded-md">{suggestion.description}</span>
                                </div>
                              );
                            })}
                          </div>
